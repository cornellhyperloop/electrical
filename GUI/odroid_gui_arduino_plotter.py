...
# ser2 = serial.Serial('/dev/cu.usbmodem14201', 9600, timeout=0)
# ser3 = serial.Serial('/dev/cu.usbmodem14201', 9600, timeout=0)
# ser4 = serial.Serial('/dev/cu.usbmodem14201', 9600, timeout=0)
ser1.close()
# ser2.close()
# ser3.close()
# ser4.close()
...
while True:
  ...
  plt.scatter(i,data1.decode())
  # x2.append(i)
  # y2.append(data2.decode())
  # plt.scatter(i,data.decode())
  # x3.append(i)
