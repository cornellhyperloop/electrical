...
class HelpPopup(QWidget):
    ...
    def initUI(self):
        ...
        self.push.setStyleSheet(
            "background-color : white; border-radius: 5px; font-weight: bold; border: 3px solid black")
    ...
    def pushedHelp(self):
        ...
        self.msgBox.setText("Click on the various buttons in order to receive more information about them")
