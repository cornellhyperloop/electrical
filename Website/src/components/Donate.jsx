...
function FeaturesBlocks() {
  var teammembers = [
    { name: "john doe", imageurl: "mechanical.png", title: "lead" },
  ];
  return (
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            {/* Content */}
            <div
              className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6 pb-20"
              data-aos="fade-right"
            >
              <div className="md:pr-4 bg-gray-50 p-3 rounded-sm lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3 font-bold">The Goal</h3>
                <p className="text-xl text-gray-600">
                  Every few centuries, something comes along that revolutionizes
                  the world - something that, once integrated with society,
...
function HeroMembers(myRef) {
  ...
  return (
    <section className="relative h-screen w-screen bg-red">
      ...
      <img
        className="h-screen absolute  mx-auto  w-full  opacity-40 object-cover"
        src={HeroImage}
        alt="Hero"
      />
      <div className="absolute w-screen z-100 mx-auto px-4 sm:px-6 bg-red50">
        ...
        <div className="pt-32 pb-12 md:pt-36 md:pb-20">
          ...
          <div>
            <div
              className=" z-100 absolute flex justify-center mb-8 h-full"
              data-aos="zoom-y-out"
              data-aos-delay="450"
            >
