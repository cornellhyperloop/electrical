...
export default class PowerSystemsSP21 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            pageData: "test"
    ...
    componentDidMount() {
        fetch("./data/PowerSystemsSP21.json").then(
    ...
    render() {
        if (this.props.display === 6) {
            ...
            return <div className="PowerSystemsSP21"></div>
        }
